...
legend_names = {
    "brown_ext_chromatic_augment_lf": "Augment",
    "brown_ext_chromatic_delegateDouble_lf": "Double Delegation",
    "brown_ext_chromatic_delegateSingle_lf": "Single Delegation",
    "brown_ext_chromatic_delegateSinglev2_lf": "Mixed Single/Double Delegation"
}
if args.title_total:
    import locale
...
for s, xy in series.items():
    ...
    plt.plot(xy[0], xy[1], label=legend_names.get(s, s))
