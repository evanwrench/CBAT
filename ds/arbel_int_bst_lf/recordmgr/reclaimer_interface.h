...
#ifndef RECLAIM_INTERFACE_BUNDLE_H
#define	RECLAIM_INTERFACE_BUNDLE_H
...
#ifndef __CYGWIN__
    RecMgr::RecoveryMgr<void *> * recoveryMgr;
#endif
...
//    inline long readAnnouncedEpoch(const int tid);
    ...
    reclaimer_interface(const int numProcesses, Pool *_pool, debugInfo * const _debug, RecMgr::RecoveryMgr<void *> * const _recoveryMgr = NULL)
#ifndef __CYGWIN__
