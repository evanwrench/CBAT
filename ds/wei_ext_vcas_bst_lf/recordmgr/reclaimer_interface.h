...
#ifndef RECLAIM_INTERFACE_VCAS_H
#define	RECLAIM_INTERFACE_VCAS_H
...
#ifndef __CYGWIN__
    RecoverVcas::RecoveryMgr<void *> * recoveryMgr;
#endif
...
//    inline long readAnnouncedEpoch(const int tid);
    ...
    reclaimer_interface(const int numProcesses, Pool *_pool, debugInfo * const _debug, RecoverVcas::RecoveryMgr<void *> * const _recoveryMgr = NULL)
#ifndef __CYGWIN__
