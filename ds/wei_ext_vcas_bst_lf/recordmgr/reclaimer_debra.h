...
#ifndef RECLAIM_EPOCH_VCAS_H
#define	RECLAIM_EPOCH_VCAS_H
...
class reclaimer_debra : public Vcas_Interface::reclaimer_interface<T, Pool> {
protected:
...
//        }
    ...
    reclaimer_debra(const int numProcesses, Pool *_pool, debugInfo * const _debug, RecoverVcas::RecoveryMgr<void *> * const _recoveryMgr = NULL)
            : Vcas_Interface::reclaimer_interface<T, Pool>(numProcesses, _pool, _debug, _recoveryMgr) {
