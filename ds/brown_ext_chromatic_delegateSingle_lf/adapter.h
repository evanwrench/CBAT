...
#define RECORD_MANAGER_T record_manager<Reclaim, Alloc, Pool, Node<K,V>, SCXRecord<K,V>, Version<K>, PropagateStatus>
...
public:
    ...
    int rangeQuery(const int tid, const K& lo, const K& hi, K * const resultKeys, V * const resultValues) {
        ...
        return ds->rangeQuery(tid, lo, hi);
    }
