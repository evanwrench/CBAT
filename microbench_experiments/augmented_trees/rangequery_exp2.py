...
#     set_cmd_compile  (exp_dict, 'make brown_ext_chromatic_delegateDouble_lf.debra')
#     set_dir_data     (exp_dict, os.getcwd() + '/data2_rangequery')
...
#     set_cmd_run      (exp_dict, 'LD_PRELOAD=../lib/libmimalloc.so ./bin/{DS_TYPENAME}.debra -nwork {TOTAL_THREADS} -nprefill 30 -insdel {INS_DEL_FRAC} -dist-zipf {ZIPF_PARAM} -rq 100 -rqsize {RQSIZE} -k {MAXKEY} -t 3000')
